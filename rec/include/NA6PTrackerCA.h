...
private:
 ...
 float mMaxDeltaThetaTrackletsCA[kMaxIterationsCA] = {0.04f, 0.1f, 0.15f, 0.3f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxDeltaPhiTrackletsCA[kMaxIterationsCA] = {0.1f, 0.2f, 0.25f, 0.5f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxDeltaTanLCellsCA[kMaxIterationsCA] = {4.f, 9.f, 18.f, 40.f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxDeltaPhiCellsCA[kMaxIterationsCA] = {0.4f, 0.6f, 1.2f, 2.4f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxDeltaPxPzCellsCA[kMaxIterationsCA] = {0.02f, 0.05f, 0.1f, 0.2f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxDeltaPyPzCellsCA[kMaxIterationsCA] = {2e-3f, 7.5e-3f, 1.5e-2f, 3.e-2f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxChi2TrClCellsCA[kMaxIterationsCA] = {100.f, 500.f, 999.f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxChi2ndfCellsCA[kMaxIterationsCA] = {100.f, 500.f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
 float mMaxChi2ndfTracksCA[kMaxIterationsCA] = {100.f, 500.f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f, 999.0f};
