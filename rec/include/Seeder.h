...
class Seeder
{
 public:
  ...
  static bool create(NA6PTrackPar& seed, bool reverse, const dimf3& p0, const dimf3& p1, const dimf3& p2, float improvePrecThreshod = 0.01f, PID pid = PID::Pion);
  static NA6PTrackPar create(bool reverse, const dimf3& p0, const dimf3& p1, const dimf3& p2, float improvePrecThreshod = 0.01f, PID pid = PID::Pion)
  {
    NA6PTrackPar seed;
    create(seed, reverse, p0, p1, p2, improvePrecThreshod, pid);
    return seed;
  }
