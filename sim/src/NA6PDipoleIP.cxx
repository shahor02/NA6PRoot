...
void NA6PDipoleIP::createMaterials()
{
...
void NA6PDipoleIP::createGeometry(TGeoVolume *world)
{
  ...
  world->AddNode(fMagnetAssembly, 1, new TGeoTranslation(param.posDipIP[0], param.posDipIP[1], param.posDipIP[2]));
}
