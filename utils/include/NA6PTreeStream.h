...
public:
  ...
  NA6PTreeStream& Endl();
  //
  NA6PTreeStream  &operator<<(Bool_t   &b) {CheckIn('B',&b);return *this;}
  NA6PTreeStream  &operator<<(Char_t   &c) {CheckIn('B',&c);return *this;}
  NA6PTreeStream  &operator<<(UChar_t  &c) {CheckIn('b',&c);return *this;}
  NA6PTreeStream  &operator<<(Short_t  &h) {CheckIn('S',&h);return *this;}
  NA6PTreeStream  &operator<<(UShort_t &h) {CheckIn('s',&h);return *this;}
  NA6PTreeStream  &operator<<(Int_t    &i) {CheckIn('I',&i);return *this;}
  NA6PTreeStream  &operator<<(UInt_t   &i) {CheckIn('i',&i);return *this;}
  NA6PTreeStream  &operator<<(Long_t   &l) {CheckIn('L',&l);return *this;}
  NA6PTreeStream  &operator<<(ULong_t  &l) {CheckIn('l',&l);return *this;}
  NA6PTreeStream  &operator<<(Long64_t &l) {CheckIn('L',&l);return *this;}
  NA6PTreeStream  &operator<<(ULong64_t &l) {CheckIn('l',&l);return *this;}
  NA6PTreeStream  &operator<<(Float_t   &f) {CheckIn('F',&f);return *this;}
  NA6PTreeStream  &operator<<(Double_t  &d) {CheckIn('D',&d);return *this;}
  NA6PTreeStream  &operator<<(TObject*o) {CheckIn(o);return *this;} 
